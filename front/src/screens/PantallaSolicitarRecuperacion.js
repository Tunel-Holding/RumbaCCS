...
function PantallaSolicitarRecuperacion({ onSuccess, registerFieldPosition, scrollToField }) {
  ...
  return (
    <View style={styles.wrapper}>
      <View style={styles.card}>
        ...
        <View onLayout={e => registerFieldPosition && registerFieldPosition('emailRec', e.nativeEvent.layout.y)}>
          ...
          <TextInput
            ...
            editable={!enviando}
            style={styles.input}
            onFocus={() => scrollToField && scrollToField('emailRec')}
          />
        </View>
