...
function ConfirmarRecuperacion({ email, navigation, registerFieldPosition, scrollToField }) { // ← recibe navigation
  ...
  return (
    <View style={styles.wrapper}>
      <View style={styles.card}>
        <View onLayout={e => registerFieldPosition && registerFieldPosition('codeConf', e.nativeEvent.layout.y)}>
          ...
          <TextInput
            ...
            editable={!enviando}
            style={styles.input}
            onFocus={() => scrollToField && scrollToField('codeConf')}
          />
        </View>

        <View onLayout={e => registerFieldPosition && registerFieldPosition('passConf1', e.nativeEvent.layout.y)}>
          ...
          <TextInput
            ...
            editable={!enviando}
            style={styles.input}
            onFocus={() => scrollToField && scrollToField('passConf1')}
          />
        </View>

        <View onLayout={e => registerFieldPosition && registerFieldPosition('passConf2', e.nativeEvent.layout.y)}>
          ...
          <TextInput
            ...
            editable={!enviando}
            style={styles.input}
            onFocus={() => scrollToField && scrollToField('passConf2')}
          />
        </View>
