        ...
        {!selectedSection && (
          <>
            ...
            <View style={styles.instructionsColumn}>
              ...
              {/* <TouchableOpacity onPress={() => setSelectedSection('entradas')} activeOpacity={0.85}>
                <View style={[styles.infoBox, { backgroundColor: '#e1f5ffff', maxWidth: 340, alignSelf: 'center' }]}>
                  <View style={[styles.infoIconCircle, { backgroundColor: '#e9f3feff' }]}>
                    <SvgXml xml={svgEntradas} width={32} height={32} />
                  </View>
                  <Text style={[styles.infoTitle, { color: '#3aa1d9ff' }]}>Entradas</Text>
                  <Text style={[styles.infoDesc, { color: '#3aa1d9ff' }]}>Este ícono representa tus entradas para los eventos que has comprado.</Text>
                </View>
              </TouchableOpacity> */}

              <TouchableOpacity onPress={() => setSelectedSection('empresas')} activeOpacity={0.85}>
                <View style={[styles.infoBox, { backgroundColor: '#bfd9ffff', maxWidth: 340, alignSelf: 'center' }]}>
                  <View style={[styles.infoIconCircle, { backgroundColor: '#ede9fe' }]}>
                    <SvgXml xml={`<svg width='24' height='24' viewBox='0 0 24 24' fill='none'>
  <circle cx='12' cy='8' r='4' stroke='#0ea5e9' stroke-width='2' fill='#dbeafe'/>
  <path d='M4 20c0-3.3137 3.134-6 7-6s7 2.6863 7 6' stroke='#0ea5e9' stroke-width='2' fill='#dbeafe'/>
                  ...
                  <Text style={[styles.infoTitle, { color: '#2ba0dfff' }]}>Empresas seguidas</Text>
                  <Text style={[styles.infoDesc, { color: '#2ba0dfff' }]}>Este ícono representa la lista que muestra empresas que sigues.</Text>
                </View>
              </TouchableOpacity>
            </View>
          </>
              ...
              guardados.map(evento => (
                <View key={evento.id} style={{ backgroundColor: '#334155', borderRadius: 16, overflow: 'hidden', marginBottom: 16 }}>
                  <View style={{ position: 'relative' }}>
                    <Image
                      source={evento.imagen ? { uri: evento.imagen } : require('../../assets/register-bg.jpg')}
...
const styles = StyleSheet.create({
  ...
  buttonRow: {
    ...
    justifyContent: 'space-between',
    alignItems: 'center',
    backgroundColor: '#1e293b', // Cuadrito contenedor
    borderRadius: 16,
    padding: 6,
    marginBottom: 16,
    width: '100%',
